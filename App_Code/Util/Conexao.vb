...
Public Class Conexao
    Private strStringConexao As String = System.Configuration.ConfigurationManager.ConnectionStrings("StringConexaoAlvara").ToString
    ...
    Public Function SalvarDataTable(ByVal dRow As DataRow, Optional ByVal GravarLog As Boolean = True, Optional ByVal CampoRetorno As String = "") As Boolean
        ...
        'colocado diretamente nas funcoes o fechamento da conexao
        If tra Is Nothing Then
            cnn.Close()
            cnn.Dispose()
            cnn = Nothing
